// Vendored from the editor's `src/data/triggerDefs.ts` — the editor is the source of truth; copy it again when it changes.
/**
 ...
 * are marked so.
 */
import type { ActionRecord, ConditionRecord } from "./triggers";
import {
